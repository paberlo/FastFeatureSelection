...
public class IWSS extends ASSearch implements OptionHandler, StartSetHandler,
	...
	/** counter of wrapper evaluations*/
	protected int m_wrapperEvals=0;
	...
	/**
	 * Number of wrapper evaluations performed during search
	 * @return number of evaluations performed if search has been called before. 0 otherwise.
	 */
	public int getWrapperEvaluations(){
		return m_wrapperEvals;
	}
	...
	public String toString() {
		...
		s += "Minimum folds better:"+m_minFolds+"\n";
		...
		s+="Wrapper evaluation performed: "+m_wrapperEvals+"\n";
		return s;
	}
